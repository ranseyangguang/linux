...
//GPIOB group APOLLO
#define CARD_GPIO_ENABLE			0xC110803CL
#define CARD_GPIO_OUTPUT              		0xC1108040L
#define CARD_GPIO_INPUT               		0xC1108044L
...
#define EGPIO_GPIOB_ENABLE			CBUS_REG_ADDR(PREG_FGPIO_EN_N)
#define EGPIO_GPIOB_OUTPUT			CBUS_REG_ADDR(PREG_FGPIO_O)
#define EGPIO_GPIOB_INPUT			CBUS_REG_ADDR(PREG_FGPIO_I)
...
#define EGPIO_GPIOE_ENABLE			CBUS_REG_ADDR(PREG_GGPIO_EN_N)
#define EGPIO_GPIOE_OUTPUT			CBUS_REG_ADDR(PREG_GGPIO_EN_N)
#define EGPIO_GPIOE_INPUT			CBUS_REG_ADDR(PREG_GGPIO_I)

#define EGPIO_GPIOF_ENABLE			CBUS_REG_ADDR(PREG_EGPIO_EN_N)
#define EGPIO_GPIOF_OUTPUT			CBUS_REG_ADDR(PREG_EGPIO_O)
#define EGPIO_GPIOF_INPUT			CBUS_REG_ADDR(PREG_EGPIO_I)

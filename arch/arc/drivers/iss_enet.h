	...
	static __inline__ unsigned int
	 READ_ENET_CONTROL_INITIALIZE(unsigned int base) {
		volatile unsigned int *p =
		    (volatile unsigned int *)(base + ENET_CONTROL_offset);
 ...
 */
	...
	static __inline__ unsigned int
	 READ_ENET_STATUS_INITIALIZED(unsigned int base) {
		volatile unsigned int *p =
		    (volatile unsigned int *)(base + ENET_STATUS_offset);
		unsigned int val = *p;	/* i/o read */
		return (unsigned int)((val >> 0) & 0x00000001);
	}
 ...
 */
	...
	static __inline__ unsigned int
	 READ_ENET_TX_SIZE_TX_SIZE(unsigned int base) {
		volatile unsigned int *p =
		    (volatile unsigned int *)(base + ENET_TX_SIZE_offset);
		unsigned int val = *p;	/* i/o read */
		return val;
	}
 ...
 */
	...
	static __inline__ unsigned int
	 READ_ENET_TX_BUFFER_TX_BUFFER(unsigned int base) {
		volatile unsigned int *p =
		    (volatile unsigned int *)(base + ENET_TX_BUFFER_offset);
		unsigned int val = *p;	/* i/o read */
		return val;
	}
 ...
 */
	...
	static __inline__ unsigned int
	 READ_ENET_RX_SIZE_RX_SIZE(unsigned int base) {
		volatile unsigned int *p =
		    (volatile unsigned int *)(base + ENET_RX_SIZE_offset);
		unsigned int val = *p;	/* i/o read */
		return val;
	}
 ...
 */
	...
	static __inline__ unsigned int
	 READ_ENET_RX_BUFFER_RX_BUFFER(unsigned int base) {
		volatile unsigned int *p =
		    (volatile unsigned int *)(base + ENET_RX_BUFFER_offset);
		unsigned int val = *p;	/* i/o read */
		return val;
	}
 ...
 */
	 ...
	 READ_ENET_INTERRUPT_CONFIGURATION_VECTOR(unsigned int base) {
		volatile unsigned int *p =
		    (volatile unsigned int *)(base +
					      ENET_INTERRUPT_CONFIGURATION_offset);
		unsigned int val = *p;	/* i/o read */
		return (unsigned int)((val >> 0) & 0x0000ffff);
	}

	static __inline__ void
	 WRITE_ENET_INTERRUPT_CONFIGURATION_VECTOR(unsigned int base,
						   unsigned int val) {
		volatile unsigned int *p =
		    (volatile unsigned int *)(base +
					      ENET_INTERRUPT_CONFIGURATION_offset);
	...
	static __inline__ void
	 WRITE_ENET_INTERRUPT_CONFIGURATION_LEVEL(unsigned int base,
						  unsigned int val) {
		volatile unsigned int *p =
		    (volatile unsigned int *)(base +
					      ENET_INTERRUPT_CONFIGURATION_offset);

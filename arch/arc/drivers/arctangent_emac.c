...
printk(KERN_CRIT "\n\n\n\n\n***** GOT LOCK *******\n\n\n\n");
        kernel_thread(thread2, NULL, CLONE_KERNEL);
...
{
    unsigned int flags;
    printk(KERN_CRIT "Attempting to take spinlock\n");
    spin_lock_irqsave (&test_lock, flags);
    printk(KERN_CRIT "******* GOT LOCK AGAIN ... OOOOPS\n");

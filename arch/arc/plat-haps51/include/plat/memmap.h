...
#define GPIO_BASE0		0xC1000000
#define GPIO_REG_SZ		0x00002000

#define DW_INTC_BASE		0xC2000000
#define DW_INTC_REG_SZ		0x01000000

#define SDIO_BASE		0xC6000000
#define SDIO_REG_SZ		0x01000000

#define DW_PGU_BASE		0xC9000000
#define DW_PGU_REG_SZ		0x01000000

#define GPIO_BASE1		0xE0006000

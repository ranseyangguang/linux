...
/* Don;t use these. Use the DMA Mapping API */
static inline __deprecated unsigned long virt_to_bus(volatile void * address)
{
    return (virt_to_phys(address) - PAGE_OFFSET);
}

static inline __deprecated void *bus_to_virt(unsigned long address)
{

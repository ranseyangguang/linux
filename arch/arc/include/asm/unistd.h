 ...
 * 6 and 7 default to level 2 so don't use them. Dont forget to change vector
...
#define __NR_afs_syscall		137	/* Andrew File System */
...
#define __NR_getpmsg			188	/* streams */
#define __NR_putpmsg			189	/* streams */
...
/* ARC uclibc implements waitpid() using wait4 so don't need this anymore */
